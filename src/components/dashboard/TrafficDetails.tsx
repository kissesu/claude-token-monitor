  ...
  return (
    <div className="animate-slide-up delay-200">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="p-3 rounded-lg border border-neonBlue/20 bg-neonBlue/5 hover:bg-neonBlue/10 transition-colors flex items-center justify-between group">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-mono uppercase text-neonBlue">输入 (Input)</div>
        ...
        <div className="p-3 rounded-lg border border-neonPurple/20 bg-neonPurple/5 hover:bg-neonPurple/10 transition-colors flex items-center justify-between group">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-mono uppercase text-neonPurple">输出 (Output)</div>
              <div className="text-sm font-medium text-primary">
